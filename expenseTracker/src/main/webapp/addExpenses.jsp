    ...
    <div id="container">
        ...
        <div id="display">
            <div id="innerDiv">
                ...
                <section id="section2">
                    <aside><b>Add Expenses</b></aside>
                    <aside><input type="text" placeholder="Amount" style="width:21.5vw;" name="amount"></aside>
                    <aside><input type="date" placeholder="" style="width:21.5vw;height:2.5vh;" name="date"></aside>
                    <aside>
                        <select  id="" style="width:21.5vw;height:3vh;border-radius:10px;text-align: center;" name="utility">
                    ...
                    <aside><textarea  id="" cols="19.5" rows="8" style="border-radius: 10px;width:21.5vw;" name="description"></textarea></aside>
