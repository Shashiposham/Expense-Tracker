...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
    ...
    <style>
        ...
        #display {
            background: radial-gradient(circle at center, yellow, black, purple);
            width: 100vw;
            height: 100vh;
            display: flex;
            flex-direction: row;
...
<body>
        ...
        <div id="display">
            <section>
                ...
                <table cellspacing="90px">
                    <tr>
                        <td class="expense" class="end"><a href="addExpenses.jsp"><i class="fa-solid fa-hand-holding-dollar"></i><i class="fa fa-plus"></i>addExpense</a></td>
                        <td class="expense" class="end"><a href="ViewExpenses"><i class="fa-solid fa-eye"></i></a><br> viewExpenses</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="expense" class="end">
                        <a href="TotalExpense.jsp"><span class="material-symbols-outlined">functions</span><br>totalExpense</a>
                            </td>
                        <td class="expense" class="end"><i class="fa-solid fa-filter-circle-dollar"></i>filterExpense</td>
                    </tr>
                </table>
            </section>
        </div>
    ...
    <div id="menu" onmouseover="showMenu()" onmouseout="hideMenu()">
        <table border="2px" cellspacing="0px" style="margin-top: 5vh;">
            <tr class=".btn">
                <td><a href="UpdateProfile.jsp">updateProfile</a></td>
            </tr>
            <tr class=".btn">
                <td onclick="location.href='login.html'">login</td>
            </tr><br>
            <tr class=".btn">
                <td onclick="location.href='signup.html'">logout</td>
            </tr>
        </table>
    </div>
</body>
