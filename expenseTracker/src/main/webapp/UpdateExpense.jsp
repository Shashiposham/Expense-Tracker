    ...
    <div id="container">
        ...
        <div id="display">
            <div id="innerDiv">
                ...
                <section id="section2">
                    <aside><b>Update Expense</b></aside>
                    <aside><input value="<%= expense.getExpenseId() %>" hidden name="eId"></aside>
                    <aside><input type="text" placeholder="Amount" style="width:21.5vw;" name="amount" value="<%= expense.getAmount()%>"></aside>
                    <aside><input type="date" placeholder="" style="width:21.5vw;height:2.5vh;" name="date" value="<%= expense.getDate()%>"></aside>
                    <aside>
                        <select  id="" style="width:21.5vw;height:3vh;border-radius:10px;text-align: center;" name="category" value="<%= expense.getCategory()%>">
                            ...
                            <option value="Hom Maintainance">Hom Maintainance</option>
                    ...
                    <aside><textarea  id="" cols="19.5" rows="8" style="border-radius: 10px;width:21.5vw;" name="description" ><%= expense.getDescription()%></textarea></aside>
                   <button style="width: 12vw;height:3vh;background-color: rgb(89, 232, 103);border-radius: 10px;"> <aside>Add <i class="fa-solid fa-plus"></i></aside></button>
                </section>
